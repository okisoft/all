...
\subsubsection{操作説明}
% 操作説明
右上にはログインしたユーザの氏名が表示されており、「登録情報編集」ボタンを押すことで「登録情報編集画面」に遷移します。また、ログアウトボタンを押すことで、ログアウトしログイン画面へと遷移します。
...
\subsubsection{操作説明}
% 操作説明
授業タイトルのボタンを押すことで、その回の授業の「進捗確認画面」へと遷移します。
...
表内をクリックすると、そのクリックした行にあるユーザからの質問確認が行えるウィンドウが開き、そのウィンドウの回答ボタンをクリックすることで、%行の
質問回答画面へと遷移します。
...
\subsubsection{画面の概要}
% 画面の概要
質問回答画面には、左側にグループ名と、そのグループからの質問が表示されています。
図\ref{fig:24}、\ref{fig:25}にイメージ図を示します。

\subsubsection{操作説明}
% 操作説明
質問へ回答をしたい場合、その質問が表示されている部分を選択した後、右側にある回答記入欄に回答を記入し、回答ボタンをクリックすることで送信します。
...
\subsubsection{操作説明}
% 操作説明
年度ボタンを押すと、その年度の「授業回選択画面」に遷移します。
...
\subsubsection{操作説明}
% 操作説明
質問をするボタンを押すと他の画面同様、質問入力画面に移動します。
授業回選択ボタンを押すと、授業回選択画面へ戻ります。
...
\begin{figure}[phtbp]
  \begin{center}
    ...
    \caption{学生用の質問入力画面のイメージ図}\label{fig:36}
  \end{center}
\end{figure}
...
\begin{figure}[phtbp]
  \begin{center}
    ...
    \caption{学生用の質問入力画面のイメージ図(質問機能のみ)}\label{fig:37}
  \end{center}
\end{figure}
