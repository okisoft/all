...
\end{figure}
=======
本システムで使用するデータベースMySQLのテーブルについて示します。
>>>>>>> 972ef42dea6f40932ca4b5cdeda30d23cd136d8f
\subsection{ユーザテーブル}
...
=======
		\ul{課題番号} & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & & No & AUTO\_INCREMENT \\ \hline
		開講回番号 & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 開講回 & No & \\ \hline
		課題名 & VARCHAR(8) & & N  & \\ \hline
		課題内容 & VARCHAR(512) & & N & \\ \hline
>>>>>>> 972ef42dea6f40932ca4b5cdeda30d23cd136d8f
		\end{tabular}
	\end{table}
\subsection{進捗テーブル}
