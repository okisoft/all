...
\end{itemize}
	...
	\begin{table}[h]
		...
		\ul{ユーザ番号} & \ul{USER\_NO} & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} &  & No & AUTO\_INCREMENT\\ \hline
		ユーザID & USER\_ID & VARCHAR(32) & & No & UNIQUE\\ \hline
		パスワード & PASSWORD & VARCHAR(64) & & No & \\ \hline
		氏名 & USER\_NAME & VARCHAR(16) &  & No  &\\ \hline
...
\end{itemize}
	...
	\begin{table}[h]
		...
		\hline
		フィールド & 物理名 & 型 & 外部キー & Null & オプション \\ \hline\hline
		開講年度番号 & LECTURE\_YEAR\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 開講年度 & No & \\ \hline
		ユーザ番号 & USER\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & ユーザ & No & \\ \hline
		\end{tabular}
	\end{table}
...
\end{itemize}
	...
	\begin{table}[h]
		...
		\hline
		フィールド & 物理名 & 型 & 外部キー & Null & オプション\\ \hline\hline
		\ul{グループ番号} & \ul{GROUP\_NO} & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & & No & AUTO\_INCREMENT \\ \hline
		グループ名 & GROUP\_NAME & VARCHAR(16) & & No & \\ \hline
		開講年度番号 & LECTURE\_YEAR\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 授業 & No & \\ \hline
		\end{tabular}
	\end{table}
...
\end{itemize}
	...
	\begin{table}[h]
		...
		\hline
		フィールド & 物理名 & 型 & 外部キー & Null & オプション\\ \hline\hline
		グループ番号 & GROUP\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & グループ & No & \\ \hline
		ユーザ番号 & USER\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & ユーザ & No & \\ \hline
		\end{tabular}
	\end{table}
\subsection{授業テーブル}
...
\end{itemize}
	...
	\begin{table}[h]
		...
		\hline
		フィールド & 物理名 & 型 & 外部キー & Null & オプション \\ \hline\hline
		\ul{授業番号} & \ul{LECTURE\_NO} & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & & No & AUTO\_INCREMENT \\ \hline
		授業名 & LECTURE\_NAME & VARCHAR(32) & & No & UNIQUE \\ \hline
		\end{tabular}
	\end{table}
\subsection{開講年度テーブル}
...
\end{itemize}
	...
	\begin{table}[h]
		...
		\hline
		フィールド & 物理名 & 型 & 外部キー & Null & オプション \\ \hline\hline
		\ul{開講年度番号} & \ul{LECTURE\_YEAR\_NO} & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & & No & AUTO\_INCREMENT \\ \hline
		授業番号 & LECTURE\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 授業 & No & \\ \hline
		開講年度 & LECTURE\_YEAR & \begin{tabular}[c]{@{}l@{}}SMALLINT\\ UNSIGNED\end{tabular} & & No & \\ \hline
		授業形態 & LECTURE\_STYLE & ENUM & & No & \\ \hline
		\end{tabular}
	\end{table}
...
\end{itemize}
	...
	\begin{table}[h]
		...
		\hline
		フィールド & 物理名 & 型 & 外部キー & Null & オプション \\ \hline\hline
		\ul{開講回番号} & \ul{LECTURE\_TIMES\_NO} & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} &  & No & AUTO\_INCREMENT \\ \hline
		開講年度番号 & LECTURE\_YEAR\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 開講年度 & No & \\ \hline
		開講回 & LECTURE\_TIMES & \begin{tabular}[c]{@{}l@{}}TINYINT\\ UNSIGNED\end{tabular} & & No & \\ \hline
		授業題目 & LECTURE\_TITLE & VARCHAR(256) & & & \\ \hline
		\end{tabular}
	\end{table}
\subsection{公開テーブル}
...
\end{itemize}
	...
	\begin{table}[h]
		...
		\hline
		フィールド & 物理名 & 型 & 外部キー & Null & オプション \\ \hline\hline
		ユーザ番号 & USER\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & ユーザ  & & \\ \hline
		授業番号 & LECTURE\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 授業 &  & \\ \hline
		開講回番号 & LECTURE\_TIMES\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 開講回 & No & \\ \hline
		\end{tabular}
	\end{table}
...
\end{itemize}
	...
	\begin{table}[h]
		...
		\hline
		フィールド & 物理名 & 型 & 外部キー & Null & オプション \\ \hline\hline
		\ul{課題番号} & \ul{PROBLEM\_NO} & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & & No & AUTO\_INCREMENT \\ \hline
		開講回番号 & LECTURE\_TIMES\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 開講回 & No & \\ \hline
		課題名 & PROBLEM\_NAME & VARCHAR(8) & & No  & \\ \hline
		課題内容 & PROBLEM\_CONTENT & VARCHAR(512) & & No & \\ \hline
		\end{tabular}
	\end{table}
\subsection{進捗テーブル}
...
\end{itemize}
	...
	\begin{table}[h]
		...
		開講回番号 & LECTURE\_TIMES\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 開講回 & No & \\ \hline
		ユーザ番号 & USER\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & ユーザ  & & \\ \hline
		グループ番号 & GROUP\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & グループ & & \\ \hline
		進捗アイコン & PROGRESS\_ICON & ENUM & & & \\ \hline
		更新時刻 & UPDATE\_TIME & TIME & & & \\ \hline
		\end{tabular}
	\end{table}
...
\end{itemize}
	...
	\begin{table}[h]
		...
		\hline
		フィールド & 物理名 & 型 & 外部キー & Null & オプション \\ \hline\hline
		\ul{質問番号} & \ul{QUESTION\_NO} & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & & No & AUTO\_INCREMENT \\ \hline
		課題番号 & PROBLEM\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 課題 &  & \\ \hline
		質問者 & USER\_NAME & VARCHAR(16) & & & \\ \hline
		質問グループ & GROUP\_NAME & VARCHAR(16) & & & \\ \hline
		質問内容 & QUESTION\_CONTENT & VARCHAR(512) & & No & \\ \hline
		回答 & REPLY & VARCHAR(512) & & & \\ \hline
		可視化フラグ & VISIBLE\_FLAG & BOOLEAN &  & No & DEFAULT TRUE\\ \hline
		\end{tabular}
	\end{table}
...
\end{itemize}
	...
	\begin{table}[h]
		...
		\hline
		フィールド & 物理名 & 型 & 外部キー & Null & オプション\\ \hline\hline
		ユーザ番号 & USER\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 進捗  & & \\ \hline
		グループ番号 & GROUP\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 進捗 & & \\ \hline
		課題番号 & PROBLEM\_NO & \begin{tabular}[c]{@{}l@{}}INT\\ UNSIGNED\end{tabular} & 課題 & & \\ \hline
		\end{tabular}
	\end{table}
